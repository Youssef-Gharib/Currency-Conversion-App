...
import { ICompareResponse, IConvertResponse, ICurrency, ICurrencyCompare, ICurrencyConvert } from '../models/currency.model';
...
export class ApiService {
  ...
  compare(data: ICurrencyCompare): Observable<ICompareResponse> {
    return this.http
      .post<ICompareResponse>(
        `${this.baseURL}/v1/currency/compare`, data
      );
  }
}
